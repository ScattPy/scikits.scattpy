...
class testSpheroidalMatrixA(unittest.TestCase):
    ...
    def test_get_a_functionR3_1(self):
        ...
        particle = Particle(2.5)
        cv = get_cv(m, n, c, type)
        self.assertAlmostEqual(get_a_functions(m,n,c,cv,type,3,particle)(z),-0.1280857374177537 + 0.01321180926927677j)
    ...
    def test_get_a_functionR3_3(self):
        ...
        particle = Particle(5)
        cv = get_cv(m, n, c, type)
        self.assertAlmostEqual(get_a_functions(m,n,c,cv,type,3,particle)(z),0.000642762007655166 - 0.539400871910197j)

    def test_get_a_functionR3_4(self):
        n=4;m=2;c=4.5;z=-0.6;type = 1;psi=6
        particle = Particle(psi)
        cv = get_cv(m, n, c, type)
        self.assertAlmostEqual(get_a_functions(m,n,c,cv,type,3,particle)(z),0.03417296826676850 + 0.01608088386790631j,5)

    def test_get_A1(self):
        particle = Particle(5)
        c1 = 0.3; c2 = 0.4; nmax =1
...
class testSpheroidalMatrixZ(unittest.TestCase):
    ...
    def test_get_c_function_R11(self):
        n=1;m=0;c=2.5;z=0.5;type = 1;d=1.5;eps=0.4;psi=1.5
